...
suite('Content/Folders API Integration Tests', function () {
    ...
    suiteSetup(function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            client = new content_1.ContentClient({ accessId: config.accessId, accessKey: config.accessKey, endpoint: config.endpoint });
    ...
    test('should get personal folder', () => __awaiter(this, void 0, void 0, function* () {
    ...
    test('should get folder by ID', () => __awaiter(this, void 0, void 0, function* () {
        var _a;
        // First get personal folder to get a valid folder ID
        const personalResponse = yield client.getPersonalFolder();
        assert.ok((_a = personalResponse.data) === null || _a === void 0 ? void 0 : _a.id, 'Should have personal folder ID');
    ...
    test('should handle non-existent folder ID', () => __awaiter(this, void 0, void 0, function* () {
        const fakeId = '0000000000000000'; // Invalid folder ID
        const response = yield client.getFolder(fakeId);
    ...
    test('should verify personal folder structure', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield client.getPersonalFolder();
    ...
    test('should list child items in personal folder', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield client.getPersonalFolder();
    ...
    test('should handle permissions field', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield client.getPersonalFolder();
    ...
    test('should verify folder metadata timestamps', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield client.getPersonalFolder();
    ...
    test('should verify child item types', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield client.getPersonalFolder();
        const children = response.data.children;
        if (children.length === 0) {
