...
suite('Extension Test Suite', () => {
    ...
    test('All commands should be registered', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('Completion provider should be registered for sumo language', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Get completions
        const completions = yield vscode.commands.executeCommand('vscode.executeCompletionItemProvider', doc.uri, position);
        assert.ok(completions, 'Should get completions');
        assert.ok(completions.items.length > 0, 'Should have completion items');
    }));
    test('Extension should export context', () => __awaiter(void 0, void 0, void 0, function* () {
        const extension = vscode.extensions.getExtension('tba.sumo-query-language');
        assert.ok(extension);
        if (!extension.isActive) {
            yield extension.activate();
